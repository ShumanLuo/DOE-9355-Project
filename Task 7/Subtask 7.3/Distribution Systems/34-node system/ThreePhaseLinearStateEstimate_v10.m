...
% load H_34.mat;
load H_34_multiple_pmu_same_bus.mat;

% load data_2500_variable_pecan.mat
% load data_2500_variable.mat;
...
% load data_2500_variable_GMM.mat;
% Vm_Ar  = str2double(node_voltage_names_separated);
% Vm_Ar = horzcat(Vm_Ar,voltage_error_full_ready);
% Vm_Ar = sortrows(Vm_Ar,1);
% Vm_Tr_Ar  = str2double(node_voltage_names_separated);
...
% load data_2500_Gaussian_noSMerror.mat
% load data_2500_GMM_noSMerror.mat;
% load data_2500_GMM_noSMerror_RecentInstrumentaionError.mat;

load data_2500_noSMerror_noInstrumentation_justTVE.mat;
Vm_Ar  = str2double(node_voltage_names_separated);
Vm_Ar = horzcat(Vm_Ar,voltage_error_full_ready);
% Vm_Ar = horzcat(Vm_Ar,voltage_actual_full_ready);
Vm_Ar = sortrows(Vm_Ar,1);
...
% uPMUloc_all = xlsread('PMU_Loc_34_New1.xlsx','PMU_Bus');
...
% MAE_mag = Sum_mag_err_sc/(NoOfScene*NoOfState);
...
time_run = toc;
% save Result_34_True.mat Result MAPE_mag MAE_ang;
